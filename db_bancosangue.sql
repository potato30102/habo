...
--
-- Base de Dados: `db_bancosangue`
--
CREATE DATABASE IF NOT EXISTS `db_bancosangue` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `db_bancosangue`;
...
CREATE TABLE IF NOT EXISTS `tb_agendamento` (
  ...
  `ds_dataagendamento` date NOT NULL,
  `ds_horario` time NOT NULL,
...
INSERT INTO `tb_cidade` (`cd_cidade`, `nm_cidade`, `id_estado`) VALUES
(1, 'Afonso Cláudio', 8),
...
CREATE TABLE IF NOT EXISTS `tb_doacao` (
  `cd_doacao` int(11) NOT NULL AUTO_INCREMENT,
  `id_usuario` int(11) NOT NULL,
  `dt_doacao` date NOT NULL,
  `ds_confirmacao` varchar(100) NOT NULL,
  `nm_hospital` varchar(1000) NOT NULL,
...
--
-- Estrutura da tabela `tb_endereco_hospital`
--

CREATE TABLE IF NOT EXISTS `tb_endereco_hospital` (
  `cd_endereco_hospital` int(11) NOT NULL AUTO_INCREMENT,
  `id_hospital` int(11) NOT NULL,
  `ds_enedereco` varchar(100) NOT NULL,
  ...
  PRIMARY KEY (`cd_endereco_hospital`),
  KEY `id_hospital` (`id_hospital`),
  KEY `id_estado` (`id_estado`),
...
INSERT INTO `tb_estado` (`cd_estado`, `nm_estado`, `ds_uf`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
CREATE TABLE IF NOT EXISTS `tb_estadocivil` (
  `cd_estadocivil` int(11) NOT NULL AUTO_INCREMENT,
  `nm_estadocivil` varchar(100) NOT NULL,
  PRIMARY KEY (`cd_estadocivil`)
...
INSERT INTO `tb_estadocivil` (`cd_estadocivil`, `nm_estadocivil`) VALUES
(1, 'Solteiro'),
(2, 'Casado'),
(3, 'Divorciado'),
(4, 'Viúvo'),
...
CREATE TABLE IF NOT EXISTS `tb_notificacao` (
  ...
  `id_usuario` int(11) NOT NULL,
  `ds_mensagem` varchar(10000) NOT NULL,
...
--
-- Estrutura da tabela `tb_not_doacao`
--

CREATE TABLE IF NOT EXISTS `tb_not_doacao` (
  `cd_not_doacao` int(11) NOT NULL AUTO_INCREMENT,
  `id_usuario` int(11) NOT NULL,
  `id_doacao` int(11) NOT NULL,
  `ds_mensagem` varchar(10000) NOT NULL,
  `dt_notificacao` date NOT NULL,
  PRIMARY KEY (`cd_not_doacao`),
  KEY `id_usuario` (`id_usuario`),
...
INSERT INTO `tb_orientacao` (`cd_orientacao`, `nm_orientacao`) VALUES
(1, 'Heterosexual'),
(2, 'Homosexual'),
(3, 'Bisexual');
...
CREATE TABLE IF NOT EXISTS `tb_paciente` (
  ...
  `ds_paciente` varchar(1000) NOT NULL,
  `ds_foto` varchar(1000) NOT NULL,
  `nm_hospital` varchar(1000) NOT NULL,
...
--
-- Estrutura da tabela `tb_tiposanguineo`
--

CREATE TABLE IF NOT EXISTS `tb_tiposanguineo` (
  `cd_tiposanguineo` int(11) NOT NULL AUTO_INCREMENT,
  `nm_tiposanguineo` varchar(3) NOT NULL,
  PRIMARY KEY (`cd_tiposanguineo`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9 ;

--
-- Extraindo dados da tabela `tb_tiposanguineo`
--

INSERT INTO `tb_tiposanguineo` (`cd_tiposanguineo`, `nm_tiposanguineo`) VALUES
(1, 'AB+'),
(2, 'AB-'),
(3, 'A+'),
(4, 'A-'),
...
CREATE TABLE IF NOT EXISTS `tb_triagem` (
  ...
  `id_usuario` int(11) NOT NULL,
  `ds_doacao` varchar(1) NOT NULL,
  `dt_ultimadoacao` date NOT NULL,
  `id_orientacao` int(11) NOT NULL,
  `ds_tatuagem` varchar(1) NOT NULL,
  `ds_gestante` varchar(1) NOT NULL,
  `ds_viagem` varchar(1) NOT NULL,
  `ds_vacina` varchar(1) NOT NULL,
  `ds_doencac` varchar(1) NOT NULL,
  `ds_drogas` varchar(1) NOT NULL,
  `ds_malaria` varchar(1) NOT NULL,
  PRIMARY KEY (`cd_triagem`),
  KEY `id_usuario` (`id_usuario`),
  KEY `id_orientacao` (`id_orientacao`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
ALTER TABLE `tb_agendamento`
  ADD CONSTRAINT `tb_agendamento_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `tb_usuario` (`cd_usuario`),
  ADD CONSTRAINT `tb_agendamento_ibfk_2` FOREIGN KEY (`id_hospital`) REFERENCES `tb_hospital` (`cd_hospital`);

--
-- Limitadores para a tabela `tb_cidade`
--
ALTER TABLE `tb_cidade`
  ADD CONSTRAINT `tb_cidade_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `tb_estado` (`cd_estado`);

--
-- Limitadores para a tabela `tb_doacao`
--
ALTER TABLE `tb_doacao`
  ADD CONSTRAINT `tb_doacao_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `tb_usuario` (`cd_usuario`);

--
-- Limitadores para a tabela `tb_endereco_hospital`
--
ALTER TABLE `tb_endereco_hospital`
  ADD CONSTRAINT `tb_endereco_hospital_ibfk_1` FOREIGN KEY (`id_hospital`) REFERENCES `tb_hospital` (`cd_hospital`),
  ADD CONSTRAINT `tb_endereco_hospital_ibfk_2` FOREIGN KEY (`id_estado`) REFERENCES `tb_estado` (`cd_estado`),
  ADD CONSTRAINT `tb_endereco_hospital_ibfk_3` FOREIGN KEY (`id_cidade`) REFERENCES `tb_cidade` (`cd_cidade`);
...
ALTER TABLE `tb_endereco_usuario`
  ...
  ADD CONSTRAINT `tb_endereco_usuario_ibfk_2` FOREIGN KEY (`id_estado`) REFERENCES `tb_estado` (`cd_estado`),
  ADD CONSTRAINT `tb_endereco_usuario_ibfk_3` FOREIGN KEY (`id_cidade`) REFERENCES `tb_cidade` (`cd_cidade`);

--
-- Limitadores para a tabela `tb_notificacao`
--
ALTER TABLE `tb_notificacao`
  ADD CONSTRAINT `tb_notificacao_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `tb_usuario` (`cd_usuario`);

--
-- Limitadores para a tabela `tb_not_doacao`
--
ALTER TABLE `tb_not_doacao`
  ADD CONSTRAINT `tb_not_doacao_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `tb_usuario` (`cd_usuario`),
  ADD CONSTRAINT `tb_not_doacao_ibfk_2` FOREIGN KEY (`id_doacao`) REFERENCES `tb_doacao` (`cd_doacao`);

--
-- Limitadores para a tabela `tb_paciente`
--
ALTER TABLE `tb_paciente`
  ADD CONSTRAINT `tb_paciente_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `tb_usuario` (`cd_usuario`),
  ADD CONSTRAINT `tb_paciente_ibfk_2` FOREIGN KEY (`id_sangue`) REFERENCES `tb_tiposanguineo` (`cd_tiposanguineo`);

--
-- Limitadores para a tabela `tb_triagem`
--
ALTER TABLE `tb_triagem`
  ADD CONSTRAINT `tb_triagem_ibfk_1` FOREIGN KEY (`id_orientacao`) REFERENCES `tb_orientacao` (`cd_orientacao`),
  ADD CONSTRAINT `tb_triagem_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `tb_usuario` (`cd_usuario`);

--
-- Limitadores para a tabela `tb_usuario`
--
ALTER TABLE `tb_usuario`
  ADD CONSTRAINT `tb_usuario_ibfk_2` FOREIGN KEY (`id_estadocivil`) REFERENCES `tb_estadocivil` (`cd_estadocivil`),
  ADD CONSTRAINT `tb_usuario_ibfk_3` FOREIGN KEY (`id_sangue`) REFERENCES `tb_tiposanguineo` (`cd_tiposanguineo`);
